...
namespace Senai.InLock.WebApi.Repositories {
    public class JogoRepository : IJogoRepository {
        ...
        public List<JogoModel> Listar() {
                ...
                if (leitor.HasRows) {
                    ...
                    while (leitor.Read()) {
                        jogos.Add(
                            new JogoModel() {
                                /* Dados do jogo */
                                ID = Convert.ToInt32(leitor["JogoId"]),
                                Nome = leitor["NomeJogo"].ToString(),
                                ...
                                Estudio = new EstudioModel() {
                                    ID = Convert.ToInt32(leitor["EstudioId"]),
                                    Nome = leitor["NomeEstudio"].ToString()
                                }
            ...
            throw new System.Exception("Não existem jogos no banco de dados");
        }
    }
}
